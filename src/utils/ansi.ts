...
export function formatPrompt(sessionName: string, command: string): string {
...
export function formatOutputStart(): string {
  return `${COLORS.dim}${COLORS.gray}────────────────────────────────────────${COLORS.reset}`;
}

export function formatOutputEnd(): string {
  return `${COLORS.dim}${COLORS.gray}────────────────────────────────────────${COLORS.reset}`;
}

// Format session status
export function formatSessionStatus(connected: boolean): string {
  if (connected) {
...
export function formatWorkingDir(dir: string): string {
