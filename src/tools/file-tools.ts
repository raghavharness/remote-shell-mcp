...
import { fileTransfer, TransferResult } from "../features/file-transfer.js";
 ...
 */
function formatTransferResult(result: TransferResult, operation: "upload" | "download"): ToolResult {
