...
import { COLORS, formatOutputStart, formatOutputEnd, stripAnsi } from "../utils/ansi.js";
 ...
 */
export async function handleSessionSwitch(params: { sessionId: string }): Promise<ToolResult> {
 ...
 */
export async function handleSessionEnd(params: { sessionId?: string }): Promise<ToolResult> {
 ...
 */
export async function handleSessionHistory(params: { sessionId?: string; limit?: number }): Promise<ToolResult> {
 ...
 */
export async function handleSessionOutput(params: { sessionId?: string; lines?: number }): Promise<ToolResult> {
 ...
 */
export async function handleSessionSignal(params: { signal: string; sessionId?: string }): Promise<ToolResult> {
 ...
 */
export async function handleFindErrors(params: { sessionId?: string; limit?: number }): Promise<ToolResult> {
  const { sessionId, limit } = params;
