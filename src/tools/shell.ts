 ...
 */
export async function handleShellTool(params: ShellToolParams): Promise<ShellToolResult> {
 ...
 */
async function handleExitCommand(): Promise<ShellToolResult> {
  const session = sessionManager.getActiveSession();
 ...
 */
async function handleInterruptCommand(): Promise<ShellToolResult> {
  const session = sessionManager.getActiveSession();
