 ...
 */
export async function handlePaneFocus(params: { paneId: string }) {
  const { paneId } = params;
 ...
 * Close a pane
 */
export async function handlePaneClose(params: { paneId: string }) {
  const { paneId } = params;
 ...
 */
export async function handlePaneList(params: { sessionId?: string }) {
 ...
 */
export async function handlePaneExec(params: { paneId: string; command: string }) {
 ...
 */
export async function handlePaneBroadcast(params: { command: string; sessionId?: string }) {
 ...
 * Rename a pane
 */
export async function handlePaneRename(params: { paneId: string; name: string }) {
 ...
 * Focus next pane
 */
export async function handlePaneNext(params: { sessionId?: string }) {
  const { sessionId } = params;
