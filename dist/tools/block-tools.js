 ...
 */
export async function handleBlockGet(params) {
 ...
 */
export async function handleBlockCopy(params) {
 ...
 * Tag a block
 */
export async function handleBlockTag(params) {
 ...
 */
export async function handleBlockUntag(params) {
    const { blockId, tags } = params;
 ...
 */
export async function handleBlockCollapse(params) {
 ...
 * Get error blocks
 */
export async function handleBlocksErrors(params) {
    ...
    const blockLines = errorBlocks.map(block => {
        const firstErrorLine = block.output.split("\n").find(line => /error|fail|exception|denied|not found/i.test(line)) || block.output.split("\n")[0];
