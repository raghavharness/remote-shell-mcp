...
export const DEFAULT_SMART_WAIT_CONFIG = {
    baseWaitTime: 2000,
    patterns: [
...
export class SmartWait {
    config;
    constructor(config = DEFAULT_SMART_WAIT_CONFIG) {
        this.config = config;
    }
    /**
     * Calculate the appropriate wait time for a command
     */
    getWaitTime(command, explicitWaitTime) {
