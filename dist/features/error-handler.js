...
function detectPackageManager(output) {
 ...
 */
export function analyzeError(command, output, exitCode) {
 ...
 */
export function isAutoFixable(analysis) {
    return analysis.context.autoFixable === true;
}
/**
 * Get the suggested fix command
 */
export function getSuggestedFix(analysis) {
